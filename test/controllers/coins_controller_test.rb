...
class CoinsControllerTest < ActionController::TestCase
  ...
  test "should create coin" do
    assert_difference('Coin.count') do
      post :create, coin: { bid_id: @coin.bid_id, comment1: @coin.comment1, comment2: @coin.comment2, user_id: @coin.user_id }
    end
  ...
  test "should update coin" do
    patch :update, id: @coin, coin: { bid_id: @coin.bid_id, comment1: @coin.comment1, comment2: @coin.comment2, user_id: @coin.user_id }
    assert_redirected_to coin_path(assigns(:coin))
  end
